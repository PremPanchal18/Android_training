...
//            mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(marker, 25.0f));
    ...
    public void checkPermissionLocation(String permission) {
        ...
        if (ContextCompat.checkSelfPermission(map.this, permission) == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(map.this, new String[]{permission}, 55);
        } else {
